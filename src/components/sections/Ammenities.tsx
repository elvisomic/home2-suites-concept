...
export const Ammenities = () => {
    return (
        <section className="px-2 sm:px-6 md:px-12 lg:px-16 xl:px-28 2xl:px-32 3xl:px-72 h-auto overflow-hidden ">
            <div className="font-semibold w-full flex items-center justify-center h-30 text-[60px]">
                <h1>AMMENITIES</h1>
            </div>
            <div className="grid grid-cols-[49%_2%_49%] w-full h-full mt-10">
                ...
                <div className="mt-9 h-full grid grid-cols-2 grid-rows-10 md:grid-cols-3 md:grid-rows-4 gap-x-5 lg:gap-x-16  md:gap-x-16 gap-y-8 py-38 sm:px-2 md:px-4 xl:px-6 xl:whitespace-nowrap">
