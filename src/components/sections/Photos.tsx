const Slika = ({ src, cName, altText }: { src:string, cName:string, altText:string }) => {
    return <img src={src} loading="lazy" className={`object-cover w-full transform transition-transform duration-400 hover:scale-120 cursor-pointer ${cName} h-full`} alt={`${altText}`} />
}
    ...
    return (
        <section className="hidden md:h-200 xl:h-300 md:grid md:grid-cols-4 md:grid-rows-3 relative overflow-hidden">
            ...
            <div className="col-span-2 row-span-2 h-150 xl:h-200 overflow-hidden w-full">
                ...
                <Slika src="/home2-suites-concept/assets/PhotosSection/cookiesC.jpg" cName="object-[50%]" altText="Image of a Cookie" />
            </div>
            ...
            <Z cols="1" rows="1" h="100" cName="">
                ...
                <Slika src="/home2-suites-concept/assets/PhotosSection/centralParkC.jpg" cName="" altText="Image of Central Park" />
            </Z>
            ...
            <Z cols="1" rows="1" h="100" cName="">
                ...
                <Slika src="/home2-suites-concept/assets/PhotosSection/broadwayC.png" cName="" altText="Image of Broadway" />
            </Z>
            ...
            <Z cols="2" rows="2" h="200" cName="">
                ...
                <Slika src="/home2-suites-concept/assets/PhotosSection/landscapeC.jpg" cName="object-[73%]" altText="Image showing the stunning view of New York City's skyline" />
            </Z>
            ...
            <Z cols="1" rows="1" h="100" cName="">
                ...
                <Slika src="/home2-suites-concept/assets/PhotosSection/libertyC.jpg" cName="object-[30%]" altText="Image showing stunning view of Statue of Liberty City" />
            </Z>
            ...
            <Z cols="1" rows="1" h="100" cName="">
                ...
                <Slika src="/home2-suites-concept/assets/PhotosSection/dumboC.jpg" cName="" altText="Image showing the view of Manhattan Bridge from Dumbo" />
            </Z>
