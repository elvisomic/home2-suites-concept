        ...
        <div className="md:hidden relative flex justify-center h-140 overflow-hidden">
            ...
            >
                ...
                <SwiperSlide>
                    ...
                    <Button />
                    <Slika src="src/assets/PhotosSection/cookies.jpg" cName="object-[50%]" />
                </SwiperSlide>
                <SwiperSlide>
                    <Text t="A green oasis in the heart of Manhattan to explore" />
                    <Button />
                    <Slika src="src/assets/PhotosSection/centralPark.jpg" cName="" />
                </SwiperSlide>
                <SwiperSlide>
                    <Text t="Unmissable shows lighting up Broadway's legendary stages" />
                    <Button />
                    <Slika src="src/assets/PhotosSection/broadway.png" cName="" />
                </SwiperSlide>
                <SwiperSlide>
                    <Text t="Iconic skyline views you'll never forget in Manhattan" />
                    <Button />
                    <Slika src="src/assets/PhotosSection/landscape.jpg" cName="object-[73%]" />
                </SwiperSlide>
                <SwiperSlide>
                    <Text t="The world-famous symbol of freedom you must see" />
                    <Button />
                    <Slika src="src/assets/PhotosSection/liberty.jpg" cName="object-[30%]" />
                </SwiperSlide>
                <SwiperSlide>
                    <Text t="Picture-perfect views and charm to discover in DUMBO" />
                    <Button />
                    <Slika src="src/assets/PhotosSection/dumbo.jpg" cName="" />
                </SwiperSlide>
            </Swiper>
