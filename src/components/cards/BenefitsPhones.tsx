    ...
    return (
        <div className={`bg-gray-100 grid grid-rows-[40%_60%] overflow-hidden grid-cols-[30%_70%] p-2 ${cName}`} >
            <div className="row-span-2 flex items-center justify-center">
                <img loading="lazy" src={`/home2-suites-concept/assets/svg/${src}`} className="h-16 w-16 bg-gray-200 rounded-full p-2" alt={`Image showing logo for ${hText} benefit`} />
            </div>
    ...
    return (
        <section id="hiltonplus" className="lg:hidden px-4 sm:px-6 bg-gray-200 h-300 py-12">
            <div className="flex flex-col mb-12">
                <h2 className="flex text-[28px] sm:text-[40px] font-semibold">Hilton Honors Benefits</h2>
            ...
            <div className="mt-8 h-80 w-full">
                <div className="flex flex-col">
                    <h2 className="text-[20px]/12 sm:text-[24px] font-semibold">Do you want to become a member?</h2>
