    ...
    return (
        <div className={`relative 2xl:w-[355px] 2xl:h-[475px] lg:w-[270px] lg:h-[390px] object-cover overflow-hidden group ${offset}`}>
            ...
            will-change-transform">
                <h2 className="text-2xl font-dinbold mb-28">{title}</h2>
                <p className="font-mono text-sm mb-8">{description}</p>
                <button className="px-6 py-2 border border-white rounded-full text-sm font-dinbold tracking-wide hover:bg-white hover:text-[#8c6b47] transition duration-300">
                    {buttonText}
                </button>
            </div>
        </div>
