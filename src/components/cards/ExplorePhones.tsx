...
export const ExplorePhones: React.FC = () => {
    return (
        <section className="h-auto md:hidden mt-24 overflow-hidden">
            <h1 className="sm:text-[38px] text-center mb-24">Explore New York City</h1>
            <div className="relative ">
                ...
                <div className="absolute bottom-25 left-40 right-0 flex overflow-x-auto gap-4 z-20 scrollbar-none">
                    {list.map((item, index) => (
