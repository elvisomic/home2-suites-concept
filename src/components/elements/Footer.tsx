...
export const Footer = () => {
    return (
        <footer className="relative h-150 bg-white px-2 2xl:px-72 2xl:py-24 md:px-8 lg:px-24 xl:px-32 py-16 mb-28 md:mb-4">
            ...
            <div className="flex justify-between items-center w-full flex-wrap">
                <div className="flex flex-row gap-x-4 md:gap-x-4 lg:gap-x-12 flex-wrap text-[16px] md:text-[20px]">
                    <FooterLink text="ABOUT US" />
                    <FooterLink text="HELP" />
                    <FooterLink text="PRIVACY POLICY" />
                    <FooterLink text="DISCLAIMER" href="#disclaimer" />
                </div>
                <div className="text-[16px] md:text-[20px] font-light mt-4 sm:mt-0">
